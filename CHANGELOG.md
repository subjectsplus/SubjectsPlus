...
- add config form for chat vars under api config section [\#1429](https://github.com/subjectsplus/SubjectsPlus/pull/1429) ([cgb37](https://github.com/cgb37))
- Thumbnail enhancement [\#1413](https://github.com/subjectsplus/SubjectsPlus/pull/1413) ([alirsattar](https://github.com/alirsattar))
...
- Merge branch 'cgb-remove-reload-specialist' into staging [\#1425](https://github.com/subjectsplus/SubjectsPlus/pull/1425) ([cgb37](https://github.com/cgb37))
- remove window reload on subjectspecialistedit.php [\#1424](https://github.com/subjectsplus/SubjectsPlus/pull/1424) ([cgb37](https://github.com/cgb37))
- Bug fix for modal not scrolling [\#1403](https://github.com/subjectsplus/SubjectsPlus/pull/1403) ([alirsattar](https://github.com/alirsattar))

**Closed issues:**

- Sql Injection Vulnerability [\#1418](https://github.com/subjectsplus/SubjectsPlus/issues/1418)
- Add Guide Titles field to LTI hits endpoint [\#1401](https://github.com/subjectsplus/SubjectsPlus/issues/1401)
- Allow Multiple Words in Guide Types [\#1399](https://github.com/subjectsplus/SubjectsPlus/issues/1399)
- Update map on SP brochure site [\#1397](https://github.com/subjectsplus/SubjectsPlus/issues/1397)
- Blank page when editing a record [\#1396](https://github.com/subjectsplus/SubjectsPlus/issues/1396)
- Video thumbnails are required to have .jpg extension [\#1393](https://github.com/subjectsplus/SubjectsPlus/issues/1393)
- HTMLPurifier needs to be updated to be compatible with PHP 7.2 [\#1384](https://github.com/subjectsplus/SubjectsPlus/issues/1384)
