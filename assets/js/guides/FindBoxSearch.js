...
function FindBoxSearch() {
    var myFindBoxSearch = {
        ...
        strings: {
            ...
            noSearchResults: "<li><span class=\"no-box-results\">No Results</span></li>",
            findBoxSearchButtons: "<div class=\"pure-u-2-5\" style=\"text-align:right;\">" + "<button class=\"clone-button pure-button pure-button-secondary\">Link</button>&nbsp; " + "<button class=\"copy-button pure-button pure-button-secondary\">Copy</button></div></div></li>"
        ...
        search: function(search_term) {
            $.get(
                myFindBoxSearch.settings.autoCompleteUrl + search_term,
                function(data) {
                    ...
                    if (data.length != 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            if (data[i]['content_type'] == "Pluslet") {
                                ...
                                var listItem = "<li data-pluslet-id='" + data[i].id + "' class=\"pluslet-listing\">" + "<div class=\"pure-g\">" + "<div class=\"pure-u-3-5 box-search-label\" title=\"" + data[i].label + "\">" + data[i].label + "</div>" + myFindBoxSearch.strings.findBoxSearchButtons;
        ...
        loadCloneMenu: function() {
            ...
            $('.guide-list').on('change', function(data) {
                ...
                $.get("../includes/autocomplete_data.php?collection=guide&subject_id=" + subject_id + " &term=", function(data) {
