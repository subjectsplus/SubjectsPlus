...
var RecordListSearch = (function () {
    ...
    RecordListSearch.prototype.liRecordList = function (record) {
        return "<li class=\"db-list-item database-listing\" data-location='" + record.location + "' data-record-id='" + record.recordId + "' data-title='" + record.title + "' data-show-icons='" + record.showIcons + "'              data-show-note='" + record.showNote + "' data-show-description='" + record.showDescription + "'>             <div class=\"pure-g\"> <div class=\"pure-u-4-5 list-search-label\" title=\"" + record.title + "\">" + record.title + "</div>\n <div class=\"pure-u-1-5\" style=\"text-align:right;\">             <button class=\"add-to-list-button pure-button pure-button-secondary\"> <i class=\"fa fa-plus\"></i></button></div>              </div>             <div class=\"db-list-item-link\"><a href='" + record.location + "' target='_blank'>" + record.location + "</a></div>             </li>";
    };
