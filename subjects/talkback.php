...
?>
    ...
    <div class="pure-g">
        ...
        <div class="pure-u-1 pure-u-lg-1-3">
            ...
            <div class="pluslet">
                <div class="titlebar">
                    <div class="titlebar_text"><?php print _( "Tell Us What You Think" ); ?></div>
                </div>
                <div class="pluslet_body">
                    <p><i class="fa fa-exclamation-triangle" aria-hidden="true"></i>
                        <strong><?php print _( "Wait!  Do you need help right now?" ); ?></strong><br/><?php print _( "Visit the Research Desk!" ); ?>
                    </p>
                    <br/>
