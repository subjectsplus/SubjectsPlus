...
if (isset($_POST["searchterm"]) && $_POST["searchterm"] != "") {
    ...
    foreach ($expertArray as $key => $value) {
      ...
      $name_id = explode("@", $librarian_email);
	    ...
	    $exp_profile = "<li>
<div class=\"expert-img\">" . $exp_image . "</div>
<div class=\"expert-label\">
<a href=\"" . PATH_TO_SP . "subjects/staff_details.php?name=" . $name_id[0] . "\">" . $value['fullname'] . "</a><br />
<div class=\"expert-subject-min\">" . $value['subject'] . "</div>
</div>".
//<div class=\"expert-tooltip\" id=\"tooltip-" . $name_id[0] . "\">
//<div class=\"expert-title\">" . $value['title'] . "</div>
//<div class=\"expert-subjects\"><strong>Subjects:</strong> " . $value['subject'] . " ...
//</div>
//</div>
"</li>";
