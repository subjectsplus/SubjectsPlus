...
<div class="pluslet">
    ...
    <div class="pluslet_body">
        <h2>Need help <strong>now</strong>? <br/><a href="">Ask a Librarian</a>.</h2>
            ...
            <form id="tellus" action="<?php print $form_action; ?>" method="post" class="pure-form">
                <div class="talkback_form <?php print $tb_bonus_css; ?>">
                    <p><strong><?php print _( "Your comment:" ); ?></strong><br/>
                        ...
                        <input type="text" id="suggestion_email" name="suggestion_email" size="20" value="<?php print $this_name; ?>"
                               class="form-item"/>
                        <br/>
