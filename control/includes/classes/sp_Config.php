...
class sp_Config
{
	...
	public function checkDBConnection( )
	{
		...
		try
		{
			@$lobjConnection = new sp_DBConnector( $this->lobjNewConfigValues['uname'], $this->lobjNewConfigValues['pword'], $this->lobjNewConfigValues['dbName_SPlus'], $this->lobjNewConfigValues['hname'] );
		}
		catch(Exception $e)
		{
