...
if(!isset($_GET['id']))
{
	if(isset($_POST['email']))
	{
		...
		{
			$introtext = "<p align=\"center\" class=\"clear-both\" class=\"smaller\"><br />" . _("{$lobjStaff->getMessage()}") . "</p>";
			...
			$introtext = "<p align=\"center\" class=\"clear-both\" class=\"smaller\"><br /><strong>" . _("An email has been sent to reset your password.  Please click the link in the email and follow the instructions.") . "</strong></p>";
		}
	}else{
		$lobjStaff = new Staff();

		$introtext = "<p align=\"center\" class=\"clear-both\" class=\"smaller\"><br />" . _("Please enter your <strong>email</strong> so we can email you a link to reset your password.") . "</p>";
	...
	if(isset($_POST['password']))
	{
		if($lobjStaff->correctPassword($_POST['password']))
		{
			if($_POST['password'] == $_POST['password_confirm'])
			{
				...
				$introtext = "<p align=\"center\" class=\"clear-both\" class=\"smaller\"><br />" . _("Password has been updated.") . "</p>";
				$introtext .= '<br><p align="center"><a href="login.php">Login</a></p>';
			}else{
				$introtext = "<p align=\"center\" class=\"clear-both\" class=\"smaller\"><br /><span style=\"background-color:yellow;\">" . _("Passwords did not match.") . "</span><br />" ._("Please enter your new password.")
			...
			$introtext = "<p align=\"center\" class=\"clear-both\" class=\"smaller\"><br /><span style=\"background-color:yellow;\">" . _("Password doesn't meet requirements.") . "</span><br />" ._("Please enter your new password.")
					. "<br /><strong>" . _("Password must have at least one letter, one number, one special character, and be at least 6 characters long.") . "</strong></p>";
		...
		{
			$introtext = "<p align=\"center\" class=\"clear-both\" class=\"smaller\"><br />" . _("The id and email do not match or the id does not exits or the link has expired.") . "</p>";
		}else{
			$introtext = "<p align=\"center\" class=\"clear-both\" class=\"smaller\"><br />" . _("Please enter your new password.")
					. "<br /><strong>" . _("Password must have at least one letter, one number, one special character, and be at least 6 characters long.") . "</strong></p>";
