...
<head>
    ...
    <style type="text/css" media="all">@import "<?php print $AssetURL; ?>css/admin/admin_styles.css";
            ...
            if (isset($_POST['submit_setup_db_config'])) {
                ...
                if ($lstrMessage != '') {
                    ...
                    if ($lobjReturn) {
                        ...
                        if (!isInstalled()) {
                            ?>
                            <div class="install-pluslet">Please make sure you are not currently logged in on any
                                installation of SubjectsPlus on current server.<br/><a href="install.php">Run the
                                    install!</a></div> <?php
                        } else {
                            ?>
