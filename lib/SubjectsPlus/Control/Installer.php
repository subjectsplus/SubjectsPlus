	...
	function __construct()
	{
		...
		$this->lobjCreateQueries = array(
					...
					"CREATE TABLE `location` (
					  ...
					  `trial_start` date NULL DEFAULT NULL,
					  `trial_end` date NULL DEFAULT NULL,
  ...
  PRIMARY KEY (`stats_id`)
		...
		$this->lobjInsertQueries = array(
				...
				(15,'','','',0,'Reserved_for_Special','',0,0,NULL,0,NULL,0)",
					...
					"INSERT INTO `location` VALUES (1,1,'','http://www.subjectsplus.com/wiki/',1,'Y','',NULL,NULL,'','',NULL,NULL)",
