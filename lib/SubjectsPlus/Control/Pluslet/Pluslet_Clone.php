...
require_once("Pluslet.php");
 ...
 class Pluslet_Clone extends \SubjectsPlus\Control\Pluslet {
	 ...
	 public function __construct($pluslet_id, $flag="", $subject_id, $isclone="") {
		 ...
		 $this->db = new \SubjectsPlus\Control\Querier;
		 $this->_id = $pluslet_id;
		 $this->_type = "Clone";
     ...
     public function getPlusletType($pluslet_id) {
         ...
         $db = new \SubjectsPlus\Control\Querier();
	 ...
	 public function getPlusletCloneBody($type, $master, $subject_id) {
		 ...
		 switch($type) {
             ...
             case "LinkList":
                 $cloned_pluslet = new LinkList($master, null, $subject_id, 1);
                 break;

			 case "Related":
				 $cloned_pluslet = new Related($master, null, $subject_id, 1);
				 break;

			 case "Chat":
				 $cloned_pluslet = new Chat($master, null, $subject_id, 1);
				 break;

			 case "QP":
				 $cloned_pluslet = new QP($master, null, $subject_id, 1);
				 break;

			 case "PrimoSearch":
				 $cloned_pluslet = new PrimoSearch($master, null, $subject_id, 1);
				 break;

			 case "Card":
				 $cloned_pluslet = new Card($master, null, $subject_id, 1);
				 break;

			 case "HTML5Video":
				 $cloned_pluslet = new HTML5Video($master, null, $subject_id, 1);
				 break;

			 case "TOC":
				 $cloned_pluslet = new TOC($master, null, $subject_id, 1);
				 break;

			 case "Feed":
				 $cloned_pluslet = new Feed($master, null, $subject_id, 1);
				 break;

			 case "SocialMedia":
				 $cloned_pluslet = new SocialMedia($master, null, $subject_id, 1);
				 break;

			 case "SubjectSpecialist":
				 $cloned_pluslet = new SubjectSpecialist($master, null, $subject_id, 1);
				 break;

			 case "Basic":
				 $cloned_pluslet = new Basic($master, null, $subject_id, 1);
				 break;

             case "BookList":
                 $cloned_pluslet = new BookList($master, null, $subject_id, 1, $this->_pluslet_id);
                 break;
		 }
