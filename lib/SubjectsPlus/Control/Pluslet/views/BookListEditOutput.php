...
<textarea rows="4" cols="30" name="BookList-extra-isbn"
          placeholder="<?php print _("Please insert a comma-separated ISBNs list"); ?>"><?php
    if ($this->_extra != null) {
...
<fieldset>
    <legend><?php print _("Get book's cover from"); ?></legend>
...
<fieldset>
    <legend><?php print _("Get book's metadata from"); ?></legend>
