...
// Get our permission tags, or ptags
	...
	public function outputPersonalInfoForm() {
		...
		if ( in_array( _( 'address' ), $require_user_columns ) ) {
			$street_address_required = "required_field";
		} else {
			$street_address_required = "";
		}
		if ( in_array( _( 'city' ), $require_user_columns ) ) {
			$city_required = "required_field";
		} else {
			$city_required = "";
		}
		if ( in_array( _( 'state' ), $require_user_columns ) ) {
			$state_required = "required_field";
		} else {
			$state_required = "";
		}
		if ( in_array( _( 'zip' ), $require_user_columns ) ) {
			$zip_required = "required_field";
		} else {
			$zip_required = "";
		}
		if ( in_array( _( 'home_phone' ), $require_user_columns ) ) {
			$home_phone_required = "required_field";
		} else {
			$home_phone_required = "";
		}
		if ( in_array( _( 'cell_phone' ), $require_user_columns ) ) {
			$cell_phone_required = "required_field";
		} else {
			$cell_phone_required = "";
		}
	...
	public function outputEmergencyInfoForm() {
		...
		if ( in_array( _( 'emergency_contact' ), $require_user_columns ) ) {
			$emergency_contact_required = "required_field";
		} else {
	...
	public function outputLatLongForm() {
		...
		// set up required fields based on fields in config
		if ( in_array( _( 'lat_long' ), $require_user_columns ) ) {
			$lat_long_required = "required_field";
		} else {
			$lat_long_required = "";
		}
