 ...
 */
final class Version20220411133107 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add uuid to Pluslet entity.';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE pluslet ADD uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        $this->addSql('CREATE UNIQUE INDEX pluslet_uuid ON pluslet (uuid)');
        ...
        $this->addSql('UPDATE pluslet SET uuid = UNHEX(REPLACE(uuid_v4s(), "-" COLLATE utf8mb4_unicode_ci, "" COLLATE utf8mb4_unicode_ci)) WHERE uuid IS NULL;');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('DROP INDEX pluslet_uuid ON pluslet');
        $this->addSql('ALTER TABLE pluslet DROP uuid');
    }
}
