 ...
 */
final class Version20220413190340 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE tab ADD uuid BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\'');
        $this->addSql('CREATE UNIQUE INDEX tab_uuid ON tab (uuid)');
    ...
    {
        $this->addSql('DROP INDEX tab_uuid ON tab');
        $this->addSql('ALTER TABLE tab DROP uuid');
    }
}
